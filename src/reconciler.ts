import { DELETION, FunctionComponent, HostComponent, HostText, PLACEMENT, UPDATE } from './constants'
import { deletions } from './scheduler'
import type { ReactElement } from 'react'
import type { Fiber } from './types'

function childReconciler(shouldTrackSideEffects: boolean): (current: Fiber | null, wip: Fiber, newChild: any) => void {
  ...
  function updateElement(wip: Fiber, oldFiber: Fiber, newChild: any): Fiber | null {
    if (oldFiber != null) {
  ...
  function reconcileChildFibers(current: Fiber | null | undefined, wip: Fiber, newChild: any): void {
...
const createFiberFromElement = (element: ReactElement): Fiber => {
